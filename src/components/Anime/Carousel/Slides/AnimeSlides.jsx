...
import AnimeVideo from "/assets/videos/anime-video-bg.mp4";
    ...
    <>
      <div className="fixed top-0 left-0">
        <div className="relative">
          <video src={AnimeVideo} autoPlay muted loop className="lozad object-cover w-screen h-screen" loading="eager"/>
