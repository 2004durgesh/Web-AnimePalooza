            ...
            <span className="text-white font-pro-bold font-semibold flex items-center justify-between mx-4">
              {currentPage === 1 ? null : (
                <span className="flex items-center">
                  <AiOutlineLeft color="white" size={30} onClick={handleReachBeginning} cursor={"pointer"} /> Back to previous page
                </span>
              )}
              <span className="text-white font-pro-bold text-center">Page : {currentPage}</span>
              <span className="flex items-center">
                On to next page<AiOutlineRight color="white" size={30} onClick={handleReachEnd} cursor={"pointer"} />
              </span>
            </span>
